...
#define X_MAX_PIN 3                    // Added by config.ini 2026-01-31 23:12:04
#define Y_MAX_PIN 14                   // Added by config.ini 2026-01-31 23:12:04
#define Z_MAX_PIN 18                   // Added by config.ini 2026-01-31 23:12:04
#define X_MIN_PIN 3                   // Added by config.ini 2026-01-31 23:36:16
#define Y_MIN_PIN 14                   // Added by config.ini 2026-01-31 23:36:16
#define Z_MIN_PIN 18                   // Added by config.ini 2026-01-31 23:36:16
...
#define STRING_CONFIG_H_AUTHOR "(Mahmoud Salah, Mdluex i3)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "Mdluex i3"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT { 198.07, 76.63, 783.69, 200.00 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 30.00, 10.00, -4.03 }
...
// Saves ~2700 bytes of flash. Disable for release!
//#define DISABLE_M503
// Give feedback on EEPROM commands. Disable to save flash.
#define EEPROM_CHITCHAT
// Keep M503 quiet and only give errors during first load
...
// These prevent buggy inline comments in pins_RAMPS.h from causing errors
